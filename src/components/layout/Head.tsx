...
export function Head(props: Props) {
  return (
    <NextHead>
      ...
      <meta property="og:url" content="https://imnotlate.on.fleek.co/" />
      ...
      <meta property="og:image" content={'https://bafybeihaafblie2zrbb2y4dsagmyaw5txkqdznzv3ivzrtxliyhqqzhdka.ipfs.w3s.link/imnotlate'} />
